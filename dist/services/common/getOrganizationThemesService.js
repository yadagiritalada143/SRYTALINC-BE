...
const getOrgThemes = (organization_name) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield organizationThemesModel_1.default.findOne({ organization_name });
        return result;
    }
    catch (error) {
